...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/aidanqm/Soluna/main/NewMainScript.lua", true))()
```
...
1. Deleting the solunav2 folder (WITH THE GAME CLOSED).
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/aidanqm/Soluna/refs/heads/main/NewMainScript.lua)
