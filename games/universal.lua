...
local hash = loadstring(downloadFile('solunav2/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('solunav2/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('solunav2/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('solunav2/profiles/whitelist.json') and readfile('solunav2/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('solunav2/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('solunav2/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('solunav2/assets/new/radaricon.png'),
