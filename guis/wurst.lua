...
local getcustomassets = {
	['solunav2/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/aidanqm/Soluna/'..readfile('solunav2/profiles/commit.txt')..'/'..select(1, path:gsub('solunav2/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('solunav2/assets/wurst/triangle.png')
